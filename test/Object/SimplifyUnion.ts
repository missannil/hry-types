...
import type { _SimplifyUnion, SimplifyUnion } from "../../src/Object/_index";

type Test1 = _SimplifyUnion<SimplifyUnion<{ a: number } | { b: string }>>;

type Test1Expected = { a: number; b: string };

Checking<Test1, Test1Expected, Test.Pass>;

type Test2 = _SimplifyUnion<SimplifyUnion<{ a: number; b: boolean } | { b: string; c: symbol }>>;
